...
var agente_id = 2;
var agente_nombre = "Vibración";
var ruta_storage_guardar = '/reportevibracion';
	...
	if (alcance)
	{
		switch (parseInt(alcance))
		{
			case 1:
				...
				$('.info_adicional').css('display', 'inline-block');
				break;
			case 2:
				$('.info_cuerpoentero').css('display', 'none');
			...
			datatable_reporte_puntos = $('#tabla_reporte_puntos').DataTable({
				ajax: {
					...
					dataSrc: function (json)
					{
						...
						$('#total_puntosmedicion').html(json.total_puntosmedicion);


						menureporte_estado("menureporte_7_1", parseInt(json.total));
						tabla_reporte_7_1(json.tabla_reporte_7_1, json.tabla_reporte_7_1_rowsGroup, json.tabla_reporte_7_1_columnaresultado);
				...
				columns: [
					...
					// },
					{
						data: "reportevibracionevaluacion_punto",
						defaultContent: "-",
						orderable: false,
					},
					{
					...
					{
						data: "reportevibracionevaluacion_puntoevaluacion",
						defaultContent: "-",
						orderable: false,
					},
					{
					...
					{
						data: "tipoevaluacion_texto",
						defaultContent: "-",
						orderable: false,
					},
					{
						data: "reportevibracionevaluacion_numeromediciones",
						defaultContent: "-",
						orderable: false,
					},
					{
						data: "reportevibracionevaluacion_tiempoexposicion",
						defaultContent: "-",
						orderable: false,
					},
					{
...
$("#boton_reporte_nuevopuntomedicion").click(function()
{
	...
	// Campos Hidden
	$('#reportevibracionevaluacion_id').val(0);


	// Campo select areas
	$('#reportevibracionarea_id').html(selectareas);
	...
	if (parseInt(tipo_evaluacion) > 0)
	{
		...
		{ 
			case 1:
				...
				$("#reportevibracionevaluacion_promedio").val('');
				$("#reportevibracionevaluacion_promedio").attr('required', false);
				$("#reportevibracionevaluacion_promedio").css('display', 'none');


				$("#label_campo1").html('Tiempo de exposición');
				$("#reportevibracionevaluacion_tiempoexposicion").prop("selectedIndex", 0);
				$("#reportevibracionevaluacion_tiempoexposicion").css('display', 'inline-block');
				$("#reportevibracionevaluacion_tiempoexposicion").attr('required', true);


				//-------------------------------------


				$("#reportevibracionevaluacion_valormaximo").val('');
				$("#reportevibracionevaluacion_valormaximo").attr('required', false);
				$("#reportevibracionevaluacion_valormaximo").css('display', 'none');


				$("#label_campo2").html('Numero de mediciones por ejes');
				$("#reportevibracionevaluacion_numeromediciones").prop("selectedIndex", 0);
				$("#reportevibracionevaluacion_numeromediciones").css('display', 'inline-block');
				$("#reportevibracionevaluacion_numeromediciones").attr('required', true);
			...
			case 2:
				...
				$("#reportevibracionevaluacion_tiempoexposicion").prop("selectedIndex", 0);
				$("#reportevibracionevaluacion_tiempoexposicion").attr('required', false);
				$("#reportevibracionevaluacion_tiempoexposicion").css('display', 'none');


				$("#label_campo1").html('Tiempo de exposición');
				$("#reportevibracionevaluacion_promedio").css('display', 'inline-block');
				$("#reportevibracionevaluacion_promedio").val('');
				$("#reportevibracionevaluacion_promedio").attr('required', true);
				$("#reportevibracionevaluacion_promedio").attr('placeholder', 'Ej. 44min, 10 h, etc...');
			...
			default:
				...
				$("#label_campo1").html('Promedio (m/seg<sup>2</sup>)');
				$("#reportevibracionevaluacion_promedio").css('display', 'inline-block');
				$("#reportevibracionevaluacion_promedio").val('');
				$("#reportevibracionevaluacion_promedio").attr('required', true);
				$("#reportevibracionevaluacion_promedio").attr('placeholder', '');
				...
				$("#label_campo2").html('Valor Máximo Permisible (m/seg<sup>2</sup>)');
				$("#reportevibracionevaluacion_valormaximo").css('display', 'inline-block');
				$("#reportevibracionevaluacion_valormaximo").attr('required', true);
				$("#reportevibracionevaluacion_valormaximo").val(1.15);
...
function tiempo_exposicion(tiempo_exposicion)
{
	...
	{ 
		case '1 min':
			...
			break;
		case '16 min':
			var limite_az = Array('4.25', '3.75', '3.35', '3.00', '2.65', '2.35', '2.12', '2.12', '2.12', '2.12', '2.65', '3.35', '4.25', '5.30', '6.70', '8.50', '10.6', '13.2', '17.0', '21.2');
			var limite_axy = Array('1.50', '1.50', '1.50', '1.50', '1.9', '2.36', '3.0', '3.75', '4.75', '6.0', '7.5', '9.5', '11.8', '15.0', '19.0', '23.6', '30.0', '37.5', '45.7', '60.0');
			break;
		case '25 min':
			var limite_az = Array('3.55', '3.15', '2.80', '2.50', '2.24', '2.00', '1.80', '1.80', '1.80', '1.80', '2.24', '2.80', '3.55', '4.50', '5.60', '7.10', '9.00', '11.2', '14.0', '18.0');
			var limite_axy = Array('1.25', '1.25', '1.25', '1.25', '1.6', '2.0', '2.5', '3.15', '4.0', '5.0', '6.3', '8.0', '10.0', '12.5', '15.0', '20.0', '25.0', '3.5', '40.0', '50.0');
			break;
		case '1 h':
			var limite_az = Array('2.36', '2.12', '1.90', '1.70', '1.50', '1.32', '1.18', '1.18', '1.18', '1.18', '1.50', '1.90', '2.36', '3.00', '3.75', '4.75', '6.00', '7.50', '9.50', '11.8');
			var limite_axy = Array('0.85', '0.85', '0.85', '0.85', '1.06', '1.32', '1.70', '2.12', '2.65', '3.35', '4.25', '5.30', '6.70', '8.5', '10.6', '13.2', '17.0', '21.2', '26.5', '33.5');
			break;
		case '2.5 h':
			var limite_az = Array('1.40', '1.26', '1.12', '1.00', '0.90', '0.80', '0.71', '0.71', '0.71', '0.71', '0.90', '1.12', '1.40', '1.80', '2.24', '2.80', '3.55', '4.50', '5.60', '7.10');
			var limite_axy = Array('0.50', '0.50', '0.50', '0.50', '0.63', '0.8', '1.0', '1.25', '1.6', '2.0', '2.5', '3.15', '4.0', '5.0', '6.3', '8.0', '10.0', '12.5', '16.0', '20.0');
			break;
		case '4 h':
			var limite_az = Array('1.06', '0.95', '0.85', '0.75', '0.67', '0.60', '0.53', '0.53', '0.53', '0.53', '0.67', '0.85', '1.06', '1.32', '1.70', '2.12', '2.65', '3.35', '4.25', '5.30');
			var limite_axy = Array('0.355', '0.355', '0.355', '0.355', '0.450', '0.560', '0.710', '0.900', '1.12', '1.40', '1.80', '2.24', '2.80', '3.55', '4.50', '5.60', '7.10', '9.00', '11.2', '14.0');
			break;
		case '8 h':
			var limite_az = Array('0.63', '0.56', '0.50', '0.45', '0.40', '0.355', '0.315', '0.315', '0.315', '0.315', '0.40', '0.50', '0.63', '0.80', '1.00', '1.25', '1.60', '2.0', '2.5', '3.15');
			var limite_axy = Array('0.224', '0.224', '0.224', '0.224', '0.280', '0.355', '0.450', '0.560', '0.710', '0.900', '1.12', '1.40', '1.80', '2.24', '2.80', '3.55', '4.50', '5.60', '7.10', '9.00');
			break;
		case '16 h':
			var limite_az = Array('0.383', '0.338', '0.302', '0.270', '0.239', '0.212', '0.192', '0.192', '0.192', '0.192', '0.239', '0.302', '0.383', '0.477', '0.605', '0.765', '0.955', '1.19', '1.53', '1.91');
			var limite_axy = Array('0.135', '0.135', '0.135', '0.135', '0.171', '0.212', '0.270', '0.338', '0.428', '0.54', '0.675', '0.855', '1.06', '1.35', '1.71', '2.12', '2.70', '3.38', '4.28', '5.4');
			break;
		case '24 h':
			var limite_az = Array('0.280', '0.250', '0.224', '0.200', '0.180', '0.160', '0.140', '0.140', '0.140', '0.140', '0.180', '0.224', '0.280', '0.355', '0.450', '0.560', '0.710', '0.900', '1.120', '1.400');
			var limite_axy = Array('0.100', '0.100', '0.100', '0.100', '0.125', '0.160', '0.20', '0.250', '0.315', '0.40', '0.50', '0.63', '0.80', '1.00', '1.25', '1.60', '2.00', '2.50', '3.15', '4.00');
			break;
		default:
			$('.punto_tiempoexposicion').html(0);
	...
	if(tiempo_exposicion)
	{
		...
		$('input[name^="reportevibracionevaluaciondatos_frecuencia"]').each(function(key, value)
		{
			...
			$('input[name^="reportevibracionevaluaciondatos_axylimite"]').eq(key).val(limite_axy[key]);
			$('input[name^="reportevibracionevaluaciondatos_axylimite"]').eq(key).attr('readonly', true);
		});
	}
}
...
function numero_mediciones(numero_mediciones)
{
	if (parseInt(numero_mediciones) == 1)
	{
		$('input[name^="reportevibracionevaluaciondatos_frecuencia"]').each(function(key, value)
		{
			...
			$('input[name^="reportevibracionevaluaciondatos_az3"]').eq(key).attr('readonly', true);

			//-----------------

			$('input[name^="reportevibracionevaluaciondatos_ax2"]').eq(key).val('');
			$('input[name^="reportevibracionevaluaciondatos_ax2"]').eq(key).attr('required', false);
			$('input[name^="reportevibracionevaluaciondatos_ax2"]').eq(key).attr('disabled', false);
			$('input[name^="reportevibracionevaluaciondatos_ax2"]').eq(key).attr('readonly', true);

			$('input[name^="reportevibracionevaluaciondatos_ax3"]').eq(key).val('');
			$('input[name^="reportevibracionevaluaciondatos_ax3"]').eq(key).attr('required', false);
			$('input[name^="reportevibracionevaluaciondatos_ax3"]').eq(key).attr('disabled', false);
			$('input[name^="reportevibracionevaluaciondatos_ax3"]').eq(key).attr('readonly', true);

			//-----------------


			$('input[name^="reportevibracionevaluaciondatos_ay2"]').eq(key).val('');
			$('input[name^="reportevibracionevaluaciondatos_ay2"]').eq(key).attr('required', false);
			$('input[name^="reportevibracionevaluaciondatos_ay2"]').eq(key).attr('disabled', false);
			$('input[name^="reportevibracionevaluaciondatos_ay2"]').eq(key).attr('readonly', true);

			$('input[name^="reportevibracionevaluaciondatos_ay3"]').eq(key).val('');
			$('input[name^="reportevibracionevaluaciondatos_ay3"]').eq(key).attr('required', false);
			$('input[name^="reportevibracionevaluaciondatos_ay3"]').eq(key).attr('disabled', false);
	...
	else
	{
		$('input[name^="reportevibracionevaluaciondatos_frecuencia"]').each(function(key, value)
		{
			...
			$('input[name^="reportevibracionevaluaciondatos_ax2"]').eq(key).attr('disabled', false);
			$('input[name^="reportevibracionevaluaciondatos_ax2"]').eq(key).attr('readonly', false);
			$('input[name^="reportevibracionevaluaciondatos_ax2"]').eq(key).attr('required', true);
			$('input[name^="reportevibracionevaluaciondatos_ax2"]').eq(key).val('');

			$('input[name^="reportevibracionevaluaciondatos_ax3"]').eq(key).attr('disabled', false);
			$('input[name^="reportevibracionevaluaciondatos_ax3"]').eq(key).attr('readonly', false);
			$('input[name^="reportevibracionevaluaciondatos_ax3"]').eq(key).attr('required', true);
			$('input[name^="reportevibracionevaluaciondatos_ax3"]').eq(key).val('');
			...
			$('input[name^="reportevibracionevaluaciondatos_ay2"]').eq(key).attr('disabled', false);
			$('input[name^="reportevibracionevaluaciondatos_ay2"]').eq(key).attr('readonly', false);
			$('input[name^="reportevibracionevaluaciondatos_ay2"]').eq(key).attr('required', true);
			$('input[name^="reportevibracionevaluaciondatos_ay2"]').eq(key).val('');

			$('input[name^="reportevibracionevaluaciondatos_ay3"]').eq(key).attr('disabled', false);
			$('input[name^="reportevibracionevaluaciondatos_ay3"]').eq(key).attr('readonly', false);
			$('input[name^="reportevibracionevaluaciondatos_ay3"]').eq(key).attr('required', true);
			$('input[name^="reportevibracionevaluaciondatos_ay3"]').eq(key).val('');
		});
	}
}
...
$('#tabla_reporte_puntos tbody').on('click', 'td.editar', function()
{
	...
	// Campos Hidden
	$('#reportevibracionevaluacion_id').val(row.data().id);
	...
	// Campo select categorias
	reportevibracionevaluacioncategorias(row.data().reportearea_id, row.data().reportecategoria_id);


	tipo_evaluacion(row.data().reportevibracionevaluacion_tipoevaluacion);
	numero_mediciones(row.data().reportevibracionevaluacion_numeromediciones);


	// Llenar campos
	$('#reportevibracionarea_id').val(row.data().reportearea_id);
	$('#reportevibracionevaluacion_puntoevaluacion').val(row.data().reportevibracionevaluacion_puntoevaluacion);
	$('#reportevibracionevaluacion_punto').val(row.data().reportevibracionevaluacion_punto);
	// $('#reportevibracioncategoria_id').val(row.data().reportecategoria_id);
	$('#reportevibracionevaluacion_nombre').val(row.data().reportevibracionevaluacion_nombre);
	$('#reportevibracionevaluacion_ficha').val(row.data().reportevibracionevaluacion_ficha);
	$('#reportevibracionevaluacion_tipoevaluacion').val(row.data().reportevibracionevaluacion_tipoevaluacion);
	...
	{ 
		case 1:
			...
			$('.punto_tiempoexposicion').html(row.data().reportevibracionevaluacion_tiempoexposicion);
			break;
		case 2:
			$("#reportevibracionevaluacion_tiempoexposicion").prop("selectedIndex", 0);
			$('#reportevibracionevaluacion_promedio').val(row.data().reportevibracionevaluacion_tiempoexposicion);
			$('#reportevibracionevaluacion_numeromediciones').val(row.data().reportevibracionevaluacion_numeromediciones);
			$('.punto_tiempoexposicion').html(row.data().reportevibracionevaluacion_tiempoexposicion);
			break;
		default:
			$("#reportevibracionevaluacion_tiempoexposicion").prop("selectedIndex", 0);
			$("#reportevibracionevaluacion_numeromediciones").prop("selectedIndex", 0);
			$('#reportevibracionevaluacion_promedio').val(row.data().reportevibracionevaluacion_promedio);
			$('#reportevibracionevaluacion_valormaximo').val(row.data().reportevibracionevaluacion_valormaximo);
			$('.punto_tiempoexposicion').html(0);
			break;
	}
			...
			success:function(dato)
			{
				...
				if (parseInt(dato.datos.length) > 0)
				{
					$.each( dato.datos, function( key, value )
					{
						...
						$('input[name^="reportevibracionevaluaciondatos_azlimite"]').eq(key).val(value.reportevibracionevaluaciondatos_azlimite);
						$('input[name^="reportevibracionevaluaciondatos_ax1"]').eq(key).val(value.reportevibracionevaluaciondatos_ax1);
						$('input[name^="reportevibracionevaluaciondatos_ax2"]').eq(key).val(value.reportevibracionevaluaciondatos_ax2);
						$('input[name^="reportevibracionevaluaciondatos_ax3"]').eq(key).val(value.reportevibracionevaluaciondatos_ax3);
						$('input[name^="reportevibracionevaluaciondatos_ay1"]').eq(key).val(value.reportevibracionevaluaciondatos_ay1);
						$('input[name^="reportevibracionevaluaciondatos_ay2"]').eq(key).val(value.reportevibracionevaluaciondatos_ay2);
						$('input[name^="reportevibracionevaluaciondatos_ay3"]').eq(key).val(value.reportevibracionevaluaciondatos_ay3);
						$('input[name^="reportevibracionevaluaciondatos_axylimite"]').eq(key).val(value.reportevibracionevaluaciondatos_axylimite);
					});
				}
			},
			beforeSend: function()
	...
	try 
	{
		$.ajax({
			...
			success:function(dato)
			{
				...
				menureporte_estado("menureporte_7_2", parseInt(dato.total_registros));
				$('#tabla_reporte_matriz').html(dato.tabla_matriz);
