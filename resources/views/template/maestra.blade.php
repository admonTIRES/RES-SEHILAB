...
<head>
    ...
    @if(request()->is('reconocimientoergo'))
    <!-- file upload -->
    <link rel="stylesheet" href="/assets/plugins/dropify/dist/css/dropify.min.css">
    <!-- Clock picker plugins css -->
    <link href="/assets/plugins/clockpicker/dist/jquery-clockpicker.min.css" rel="stylesheet">
...
<body class="fix-header fix-sidebar card-no-border logo-center">
    ...
    {{-- pagina --}}
    <script src="/js_sitio/reconocimiento_sensorial.js?v=21"></script>
    @endif
    ...
    {{-- pagina --}}
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="/js_sitio/reconocimientoergo.js?v=51"></script>
    <script src="/js_sitio/funcionesgeneralesergo.js?v=1"></script>
    ...
    {{-- pagina --}}
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="/js_sitio/evaluacionfre.js?v=9"></script>
    <script src="/js_sitio/funcionesgeneralesergo.js?v=1"></script>
    <script src="https://cdn.jsdelivr.net/npm/echarts/dist/echarts.min.js"></script>
    ...
    <script src="/assets/plugins/datatables/jquery.dataTables.min.js"></script>
    <script src="/assets/plugins/datatables/dataTables.rowsGroup.js"></script>
    <script src="/js_sitio/recsensorial_catalogos.js?v=2.1"></script>
    <script src="/assets/plugins/dropify/dist/js/dropify.min.js"></script>
    <script src="/assets/plugins/select-search/selectize.js" type="text/javascript"></script>
    ...
    <script src="/assets/plugins/datatables/jquery.dataTables.min.js"></script>
    <script src="/assets/plugins/datatables/dataTables.rowsGroup.js"></script>
    <script src="/js_sitio/psicoInformes_catalogos.js?v=2.3"></script>
    <script src="/assets/plugins/dropify/dist/js/dropify.min.js"></script>
    <script src="/assets/plugins/select-search/selectize.js" type="text/javascript"></script>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@fullcalendar/multimonth@6.1.15/index.global.min.js"></script>
    {{-- pagina --}}
    <script src="/js_sitio/proyecto.js?v=14"></script>
    ...
    <script src="/assets/plugins/datatables/jquery.dataTables.min.js"></script>
    <script src="/js_sitio/eppcatalogos.js?v=1.6"></script>
    <script src="/assets/plugins/datatables/dataTables.rowsGroup.js"></script>
    {{-- Select search filter --}}
    <script src="/assets/plugins/select-search/selectize.js" type="text/javascript"></script>
    {{-- Select2 search filter --}}
