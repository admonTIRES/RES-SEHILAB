                                            ...
                                            <script>
                                                $(document).ready(function() {
                                                    ...
                                                    for (let year = currentYear; year >= 2017; year--) {
                                                        $('#INFORME_ANIO').append(new Option(year, year));
                                                    }
                                                });
                                            </script>
                                        </select>
...
<p>En el presente estudio se describen los resultados obtenidos durante la evaluación de Factores de Riesgo Psicosocial en el ambiente laboral, de acuerdo con lo establecido en la Norma Oficial Mexicana NOM-035-STPS2018, Factores de riesgo psicosocial en el trabajo–Identificación, análisis y prevención, realizada en las áreas de la INSTALACION,<font color="#000000" style="background-color: rgb(255, 255, 0);">los días del XX al XX de MES de AÑO."</font></p> </textarea>
                                                ...
                                                <div class="switch">
                                                    <label>
                                                        <input type="checkbox"
                                                            ...
                                                            value="{{ $dato->ID_DEFINICION_INFORME }}"
                ...
                <form method="post" enctype="multipart/form-data" name="form_reporte_objetivogeneral" id="form_reporte_objetivogeneral">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                {!! csrf_field() !!}
                                <textarea class="form-control" style="margin-bottom: 0px;" rows="8" id="INFORME_OBJETIVOGENERALES" name="INFORME_OBJETIVOGENERALES" required>Identificar y analizar los Factores de Riesgo Psicosocial en la INSTALACION.
</textarea>
                            </div>
                        </div>
                        <div class="col-12" style="text-align: right;">
                ...
                <form method="post" enctype="multipart/form-data" name="form_reporte_objetivoespecifico" id="form_reporte_objetivoespecifico">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                {!! csrf_field() !!}
                                <textarea class="form-control" style="margin-bottom: 0px;" rows="12" id="INFORME_OBJETIVOSESPECIFICOS" name="INFORME_OBJETIVOSESPECIFICOS" required></textarea>
                            </div>
                        </div>
                        <div class="col-12" style="text-align: right;">
                ...
                <div class="row">
                    <div class="col-12">
                        <p class="justificado">La metodología menciona los principios que guían las prácticas de la evaluación. Desarrollando los métodos y herramientas utilizados.<br>
                            Con base en la información recabada en el reconocimiento se seleccionan los métodos para realizar la identificación de los Factores de Riesgo Psicosocial, la cantidad de personal y las características del proceso, de conformidad en lo establecido en la NOM-035-STPS-2018.
                        </p><br>
                    </div>
                </div>
                ...
                <form method="post" enctype="multipart/form-data" name="form_reporte_metodologia_4_1" id="form_reporte_metodologia_4_1">
                    <div class="row">
                        <div class="col-12">
                            <p class="justificado"><b>Guía de referencia I</b>, Cuestionario para identificar a los trabajadores que fueron sujetos a Acontecimientos traumáticos severos. Como lo dicta la NOM-035-STPS-2018, para identificar a los trabajadores que fueron sujetos a eventos traumáticos severos o con motivo del trabajo y, canalizarlos para su atención a la institución de seguridad social o privada, o al médico del centro de trabajo o de la empresa.<br><br>
                                Con base en la información recabada en el reconocimiento se seleccionan los métodos para realizar la identificación de los Factores de Riesgo Psicosocial, la cantidad de personal y las características del proceso, de conformidad en lo establecido en la NOM-035-STPS-2018.<br><br>
                                <b>Guía de referencia III</b>, Identificación y análisis de los Factores de Riesgo Psicosocial y Evaluación del entorno organizacional en los centros de trabajo. Como lo dicta la NOM-035-STPS-2018, en los centros de trabajo que tengan entre 16 y 50 trabajadores. La identificación y análisis de los factores de riesgo psicosocial y la evaluación del entorno organizacional se realizará de conformidad con la NOM-035-STPS-2018:<br><br>
...
DESCRIPCIONACTIVIDAD
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" style="margin-bottom: 0px;" rows="20" id="DESCRIPCION_METODO" name="DESCRIPCION_METODO" required></textarea>
                            </div>
                        </div>
                        <div class="col-12" style="text-align: right;">
                            <div class="form-group">
                                <button type="submit" class="btn btn-danger waves-effect waves-light botoninforme" id="botonguardar_reporte_descripcionmetodo">Guardar método realizado para la evaluación <i class="fa fa-save"></i></button>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <style>
                    ...
                    .data-labels-contour {
                        ...
                        /* Contorno negro de 1px */
                        text-stroke: 1px #000;
                        /* Para navegadores que no sean Webkit */
                    }
                    ...
                    .text-analisis {
                        ...
                        padding: 15px;
                        background: #fff;
                        /* Fondo claro para destacar el análisis */
                        margin: 10px 0;
                    ...
                    .circle-icon {
                        ...
                        /* Cambia aquí el color del círculo */
                        border-radius: 50%;
                            ...
                            <tbody>
                                <tr>
                                    <td style="border: none; padding: 0;">
                                        <p class="title">Análisis de datos sociodemográficos (NOM-035-STPS-2018)</p>
                                        <div class="cont-graficas">
                                                ...
                                                <div class="cardgeneros" id="cardgeneros">
                                                    <div class="graph-container mt-5">
                                                        <div class="bar">
                                                            <svg viewBox="-146 0 512 512.00026" xmlns="http://www.w3.org/2000/svg">
                                                                <defs>
                                                                    <linearGradient id="gradient1" x1="0%" y1="100%" x2="0%" y2="0%">
                                                                        <stop id="stopHombreColor"
                                                                            offset="0%"
                                                                            style="stop-color:#154b75;stop-opacity:1" />
                                                                        <stop id="stopHombreBlanco"
                                                                            offset="0%"
                                                            ...
                                                            <div class="bar-label">
                                                                <span class="circle-icon" style="background:#154b75"></span>
                                                                <span id="lblHombres">Hombres: 0 (0%)</span>
                                                            </div>
                                                        </div>
                                            ...
                                            <style>
                                                ...
                                                .card-edades #grafica_edad {
                                                    height: 360px;
                                                    min-height: 360px;
                                                }
                                            </style>
                                            <div class="carddas card-edades">
                                                <p class="card-titledas">
                                                    Trabajadores evaluados por rango de edades
                                                </p>
                                            ...
                                            <div class="carddas">
                                                <p class="card-titledas">
                                                    Trabajadores evaluados por escolaridad
                                                </p>
                                            ...
                                            <div class="carddas card-estado-civil">
                                                <p class="card-titledas">
                                                    Trabajadores evaluados por estado civil
                                                </p>
                                            ...
                                            <div class="carddas">
                                                <p class="card-titledas">
                                                    Trabajadores evaluados por experiencia laboral
                                                </p>
...
<script src="/js_sitio/reportes/reportenom0353v1.js?v=18"></script>
